...
const Login = () => {
    ...
    return ( <
        ...
        <
        Link to = "/"
        className = "inline-flex items-center text-gray-600 dark:text-light hover:text-primary transition-colors mb-4" >
        <
        ...
        <
        p className = "text-gray-600 dark:text-light mt-2" > { isLogin ? 'Entre para acessar suas finanças' : 'Comece sua jornada financeira' } <
        /p>
        ...
        className = "space-y-6" > { /* Erro geral */ } {
            errors.general && ( <
                div className = "bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 px-4 py-3 rounded-lg" > { errors.general } <
                /div>
            )
        }
