                      ...
                      {editingId === item.id ? (
                        <>
                          ...
                          <button
                            ...
                            onClick={() => { setEditingId(null); setEditingAccountId(''); }}
                          >Cancelar</button>
                        </>
                      ) : (
                        <button
                        ...
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536M9 11l6 6M3 17v4h4l10.293-10.293a1 1 0 00-1.414-1.414L3 17z" /></svg>
                        </button>
                      )}
                      <button
