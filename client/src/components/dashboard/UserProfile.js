...
const UserProfile = () => {
    ...
    return ( <
        ...
        <
        div className = "grid lg:grid-cols-3 gap-6" > { /* Card Principal */ } <
        ...
        /label> {
            isEditing ? ( <
                ...
                p className = "text-lg text-gray-900 dark:text-light break-words" > { user ? .name || 'Não informado' } <
                /p>
            )
        } <
        /div> <
        ...
        Email <
        /label> <
        p className = "text-lg text-gray-900 dark:text-light break-words" > { user ? .email || 'Não informado' } <
        /p> <
        /div> <
        /div>
        ...
        /label> {
            isEditing ? ( <
                ...
                p className = "text-lg text-gray-900 dark:text-light break-words" > { formatDate(user ? .birth_date) } <
                /p>
            )
        } <
        /div> <
        ...
        /label> {
            isEditing ? ( <
                ...
                p className = "text-lg text-gray-900 dark:text-light break-words" > { user ? .phone || 'Não informado' } <
                /p>
            )
        } <
        /div> <
