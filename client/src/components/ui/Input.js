...
const Input = ({
  ...
  `.trim();
    ...
    return ( <
        ...
        {
            RightIcon && ( <
                div className = { `absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 z-10 ${onRightIconClick ? 'cursor-pointer hover:text-gray-600' : 'pointer-events-none'}` }
